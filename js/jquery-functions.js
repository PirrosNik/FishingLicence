$("document").ready(function () {
  ...
  function skipToEnd(message) {
    ...
    const error =
      currentLanguage === "greek"
        ? "Λυπούμαστε αλλά δεν δικαιούστε άδεια ερασιτεχνικής αλιείας!"
        : "We are sorry but you are not entitled to fishing licence!";
  ...
  function retrieveAnswers() {
    ...
    if (
      ...
      getEvidencesById(10);
      currentLanguage === "greek"
        ? setResult("Δικαιούται και ο συνοδός αδεια αλιείας.")
        : setResult("The companion is also entitled with a fishing licence.");
    }
    ...
    if (allAnswers[7] === "1") {
      ...
      currentLanguage === "greek"
      ? setResult(
          "Δικαιούσαι αδεια ερασιτεχνικής αλιειάς ."
        )
      : setResult(
          "You are entitled to fishing licence."
        );
      ...
      if (allAnswers[8] === "1") {
        currentLanguage === "greek"
          ? setResult(
              "Δικαιούσαι άδεια ερασιτεχνικής αλιειάς ."
            )
          : setResult(
              "You are entitled to fishing licence ."
            );
  ...
  function submitForm() {
    ...
    currentLanguage === "greek"
      ? $(".question-container").append(
          "<br /><br /><h5 class='answer'>Τα δικαιολογητικά που πρέπει να προσκομίσετε για να εκδοθεί η αδεια ερασιτεχνικής αλιείας είναι τα εξής:</h5><br />"
        )
      : $(".question-container").append(
          "<br /><br /><h5 class='answer'>The documents you need to provide in order to receive your fishing licence are the following:</h5><br />"
        );
  ...
  $("#nextQuestion").click(function () {
    if ($(".govgr-radios__input").is(":checked")) {
      ...
      if (currentQuestion === 0 && selectedRadioButtonIndex === 3) {
        ...
        currentQuestion = -1;
        currentLanguage === "greek" ? skipToEnd("Πρέπει να είστε  νόμιμος πολίτης.") : skipToEnd("You must be legal citizen .");
      } else if (currentQuestion === 3 && selectedRadioButtonIndex === 2) {
        currentQuestion = -1;
        currentLanguage === "greek" ? skipToEnd("Πρέπει να σέβεστε το περιβάλλον και τα θαλάσσια οικοσυστήματα.") : skipToEnd("You must protect and appreciate the environment and the sea ecosystems .");
      } else {
